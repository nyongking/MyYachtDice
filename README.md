...
Windows C++ 클라이언트 게임 프로젝트. DirectX 11 기반 Deferred Shading 커스텀 렌더링 엔진을 직접 구현합니다.
...
GameEngine::InitEngine()
  ...
  └── ComponentRegistry: CameraComponent / LightComponent / ModelComponent / QuadComponent 등록
```
